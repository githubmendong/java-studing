...
public class ChatWindow {
    ...
    private TextArea clientsListArea = new TextArea(1,1);
    ...
    public ChatWindow(String name, Socket socket) {
        ...
        frame.add(BorderLayout.EAST, clientsListArea); // 참여 명단 출력
            ...
            try {
                while (true) {
                    ...
                    if (line.startsWith("CONNECTED_CLIENTS:")) {
                        ...
                        String clients = line.split(":")[1];
                        connectedClientsLabel.setText("참여 수 : " + count);  //
                        clientsListArea.setText(clients.replace(",", "\n"));
                        continue;
                    }
                    //
